...
const VideoTitle = ({ title, overview }) => {
  return (
    ...
    p-20 text-white bg-gradient-to-r from-black via-transparent to-transparent
    absolute top-0"
    >
      <div className="text-6xl md:w-1/2 font-bold mb-5">{title}</div>
      <div className="md:w-1/3 text-lg line-clamp-6">{overview}</div>
